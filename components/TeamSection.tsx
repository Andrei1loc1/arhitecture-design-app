...
export default function TeamSection() {
    return (
        <section
            id="team"
            className="relative z-10 overflow-hidden bg-[#e7d8bd] px-6 py-24 md:px-10 lg:px-16 lg:py-32"
        >
          ...
          <span className="mb-6 block text-xs font-bold uppercase tracking-[0.28em] text-[#b39458]">
            03 / Echipa
                    ...
                    <h2 className="text-4xl font-black uppercase leading-[0.95] tracking-[-0.05em] text-[#2a2420] md:text-6xl">
                        Oameni care dau formă ideilor.
                    </h2>

                    <p className="mt-7 max-w-lg text-base leading-8 text-[#5a5145] md:text-lg">
                        MindSpace Studio este construit din viziune, sensibilitate estetică
                        și precizie. Fiecare proiect prinde viață prin colaborarea dintre
                        arhitectură, interior și vizualizare.
                    </p>
                ...
                <div className="relative min-h-[520px] md:min-h-[620px]">
                    ...
                    <div className="pointer-events-none absolute left-1/2 top-1/2 h-[320px] w-[320px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#b39458]/15" />
                    <div className="pointer-events-none absolute left-1/2 top-1/2 h-[440px] w-[440px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#8b765c]/10" />
                    ...
                    {/* cerc decorativ mic */}
                    <motion.div
                        className="absolute bottom-[8%] left-[20%] h-16 w-16 rounded-full border border-[#d6bf86]/45 bg-white/20 backdrop-blur-sm"
                        animate={{ y: [0, -12, 0], x: [0, 8, 0] }}
                        transition={{ duration: 5.5, repeat: Infinity, ease: "easeInOut" }}
                    />

                    <motion.div
                        className="absolute bottom-[18%] right-[18%] h-8 w-8 rounded-full bg-[#c7a85f]/35 blur-[1px]"
